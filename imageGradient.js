(function () {
    ...
    drawImageGradient = function (img, x, y, gradient,ctx) {
        //var ctx = this;
        ...
        var imageImageData = imgCtx.getImageData(0, 0, 1024,1024);

        var ctxImageData = ctx.getImageData(x, y, 1024,1024);
